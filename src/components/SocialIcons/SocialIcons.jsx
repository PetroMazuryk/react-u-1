...
const SocialIcons = () => {
  return (
    <ul className={styles.socialList}>
      ...
      <li className={styles.socialItem}>
        <Link to="#" className={styles.socialLink} aria-label="Twitter">
      ...
      <li className={styles.socialItem}>
        <Link to="#" className={styles.socialLink} aria-label="Google Plus">
      ...
      <li className={styles.socialItem}>
        <Link to="#" className={styles.socialLink} aria-label="Instagram">
